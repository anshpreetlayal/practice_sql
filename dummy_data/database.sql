...
values (1, 'John', 'Doe', 'john@example.com', 123-345-334, 2021-03-14),
       ...
       (3, 'Katy', 'John', 'katy@example.com', 346-574-357, 2020-03-12, );
        ...
        (15, 'Liam', 'White', 'liam@example.com', 555-777-8888, '2019-10-17');
         ...
         (18, 'Aiden', 'Taylor', 'aiden@example.com', 777-333-1111, '2020-04-22');
         (19, 'Chloe', 'Wilson', 'chloe@example.com', 999-111-5555, '2017-12-09');

Insert into Order (OrderID, CustomerID, OrderDate, TotalAmount)
 values (1, 101, '2023-01-10', 500);
        (2, 102, '2023-01-11', 750);
        (3, 103, '2023-01-12', 320);
        (4, 104, '2023-01-13', 600);
        (5, 105, '2023-01-14', 420);
        (6, 106, '2023-01-15', 850);
        (7, 107, '2023-01-16', 700);
        (8, 108, '2023-01-17', 900);
        (9, 109, '2023-01-18', 550);
        (10, 110, '2023-01-19', 480);
        (11, 111, '2023-01-20', 690);
        (12, 112, '2023-01-21', 740);
        (13, 113, '2023-01-22', 320);
        (14, 114, '2023-01-23', 560);
        (15, 115, '2023-01-24', 480);
        (16, 116, '2023-01-25', 710);
        (17, 117, '2023-01-26', 630);
        (18, 118, '2023-01-27', 820);
        (19, 119, '2023-01-28', 950);
        (20, 120, '2023-01-29', 400);
